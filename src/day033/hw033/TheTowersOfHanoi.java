...
public class TheTowersOfHanoi {
    ...
    /**
     * The Towers of Hanoi is one of the possible particular recursive solutions.
     *
    ...
    public static String nextIteration(int disksAmount, int sourceHolder, int targetHolder) {
